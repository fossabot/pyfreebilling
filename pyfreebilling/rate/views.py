...
from .forms import CallerNumListForm, ProviderRatecardForm, CustomerRatecardForm, CustomerPrefixRateForm, ProviderPrefixRateForm, CustomerDestinationRateForm, ProviderDestinationRateForm, CustomerCountryTypeRateForm, ProviderCountryTypeRateForm, CustomerCountryRateForm, ProviderCountryRateForm, CustomerRegionTypeRateForm, ProviderRegionTypeRateForm, CustomerRegionRateForm, ProviderRegionRateForm, CustomerDefaultRateForm, ProviderDefaultRateForm
