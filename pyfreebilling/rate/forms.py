...
class ProviderRatecardForm(forms.ModelForm):
    class Meta:
        ...
        fields = ['name', 'rc_type', 'provider_prefix', 'estimated_quality', 'status', 'status_changed', 'created', 'modified']


class CustomerRatecardForm(forms.ModelForm):
    class Meta:
        model = CustomerRatecard
        fields = ['rc_type', 'name', 'status', 'status_changed', 'created', 'modified']
